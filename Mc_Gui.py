...
correct_dir_ans = easygui.ynbox('Is minecraft installed on your C drive? (Click yes if unsure)', 'Title', ('Yes', 'No'))
print(correct_dir_ans)
home_dir = os.path.expanduser("~")
local_dir_path = os.path.join(home_dir, "AppData", "Roaming", ".minecraft", "mods")
